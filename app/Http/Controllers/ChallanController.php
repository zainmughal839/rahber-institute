...
// List all challans with filters & view all
public function index(Request $request)
{
    $query = Challan::with('student')->latest();
...
// AJAX: load programs / classes / students
...
// Add these methods to your existing ChallanController
...
public function destroy($id)
{
    DB::transaction(function () use ($id) {
        ...
        // ✅ Delete ALL ledger entries related to this challan
